...
function createWeek(date) {
	...
	newCol.setAttribute("class","col-3 butPrecSuiv");
	...
	newCol.setAttribute("class","col-6 divDateDuJour");
	var colLastChild = newCol.LastChild;
	...
	for(var j=0; j<7; j++) {
		...
		if(j<5) {
			newCol2.setAttribute("class","col-2 Colonne");
		} else {
			newCol2.setAttribute("class","col-1 Colonne");
		}
	...
	for (var i = 0; i < maxWeek; i++) {
		...
		for(var j=0; j<7;j++) {
			...
			if(j<5) {
				newCol.setAttribute("class","col-2 Colonne");
			} else {
				newCol.setAttribute("class","col-1 Colonne");
			}
			var colLastChild = newCol.LastChild;
