...
public class RestApiGreetingController {
	...
	// Rest Actions
	@RequestMapping(path="/demo/greeting2", method=RequestMethod.GET)
	...
	// list
	// -----
	@RequestMapping(path="/demo/greeting2/list", method=RequestMethod.GET)
	public Iterable<Greeting> listAction(
	...
	// -----------------------------------
	@RequestMapping(path="/demo/greeting2/{id}/show", method=RequestMethod.GET)
	...
	@RequestMapping(path="/demo/greeting2/create", method=RequestMethod.POST)
	...
	@RequestMapping(path="/demo/greeting2/{id}/delete", method=RequestMethod.DELETE)
	...
	@RequestMapping(path="/demo/greeting2/{id}/edit", method=RequestMethod.PUT)
	...
	@RequestMapping(path="/demo/greeting2/addBourrin", method=RequestMethod.GET)
